...
function renderLaTeX($input, array $args, Parser $parser, PPFrame $frame) {
  ...
  $result = shell_exec('extensions/Hyperlatex-2.7/bin/hyperlatex ' . escapeshellarg($dir . '/index.tex') . ' 2>&1');
  if (is_file($dir . '/index.html')) {
    ...
    $output = 'LaTeX ERROR: ' . $result . 'extensions/Hyperlatex-2.7/bin/hyperlatex ' . escapeshellarg($dir . '/index.tex') . ' 2>&1';
